...
public class Sprite {
	...
	public static Sprite player_left = new Sprite(DEFAULT_SIZE, 3, 0, SpriteSheet.tiles, 14, 16);
	...
	public static Sprite player_left_1 = new Sprite(DEFAULT_SIZE, 3, 1, SpriteSheet.tiles, 14, 16);
	public static Sprite player_left_2 = new Sprite(DEFAULT_SIZE, 3, 2, SpriteSheet.tiles, 14, 16);
	...
	public Image getFxImage() {
        ...
        for (int x = 0; x < _realWidth; x++) {
            for (int y = 0; y < _realHeight; y++) {
                if ( _pixels[x + y * _realHeight] == TRANSPARENT_COLOR) {
                    pw.setArgb(x, y, 0);
                }
                else {
                    pw.setArgb(x, y, _pixels[x + y * _realHeight]);
                }
            }
        }
